...
function B2EdgeSeparation(
	...
	const normal1World: B2Vec2 = B2Rot.MulRV(
		xf1.q,
		normals1[edge1],
		B2EdgeSeparation_s_normal1World
	)
	const normal1: B2Vec2 = B2Rot.MulTRV(
		xf2.q,
		normal1World,
		B2EdgeSeparation_s_normal1
	)
	...
	const v1: B2Vec2 = B2Transform.MulXV(
		xf1,
		vertices1[edge1],
		B2EdgeSeparation_s_v1
	)
	const v2: B2Vec2 = B2Transform.MulXV(
		xf2,
		vertices2[index],
		B2EdgeSeparation_s_v2
	)
	const separation: number = B2Vec2.DotVV(
		B2Vec2.SubVV(v2, v1, B2Vec2.s_t0),
		normal1World
	)
	return separation
}
...
export function B2CollidePolygons(
	...
	const localTangent: B2Vec2 = B2Vec2.SubVV(
		local_v12,
		local_v11,
	...
	const localNormal: B2Vec2 = B2Vec2.CrossVOne(
		localTangent,
		B2CollidePolygons_s_localNormal
	)
	const planePoint: B2Vec2 = B2Vec2.MidVV(
		local_v11,
		local_v12,
		B2CollidePolygons_s_planePoint
	)

	const tangent: B2Vec2 = B2Rot.MulRV(
		xf1.q,
		localTangent,
