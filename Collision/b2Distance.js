...
exports.B2Distance = exports.B2Simplex = exports.B2SimplexVertex = exports.B2_gjkMaxIters = exports.B2_gjkIters = exports.B2_gjkCalls = exports.B2DistanceOutput = exports.B2DistanceInput = exports.B2SimplexCache = exports.B2DistanceProxy = void 0;
    ...
    ReadCache(cache, proxyA, transformA, proxyB, transformB) {
        ...
        if (this.m_count > 1) {
            ...
            if (metric2 < 0.5 * metric1 ||
                2 * metric1 < metric2 ||
                metric2 < b2Settings_1.B2_epsilon) {
                // Reset the simplex.
                this.m_count = 0;
            }
        }
