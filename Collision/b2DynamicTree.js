...
class B2DynamicTree {
    ...
    RayCast(callback, input) {
        ...
        while (stack.GetCount() > 0) {
            ...
            const separation = b2Math_1.B2Abs(b2Math_1.B2Vec2.DotVV(v, b2Math_1.B2Vec2.SubVV(p1, c, b2Math_1.B2Vec2.s_t0))) -
                b2Math_1.B2Vec2.DotVV(abs_v, h);
            if (separation > 0) {
                continue;
            }
            if (node.IsLeaf()) {
    ...
    MoveProxy(proxy, aabb, displacement) {
        ...
        const r_x = b2Settings_1.B2_aabbExtension +
            b2Settings_1.B2_aabbMultiplier *
