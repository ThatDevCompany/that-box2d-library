...
export class B2MotorJoint extends B2Joint {
    ...
    InitVelocityConstraints(data) {
        ...
        const rA = B2Rot.MulRV(qA, B2Vec2.NegV(this.m_localCenterA, B2Vec2.s_t0), this.m_rA);
        ...
        B2Vec2.SubVV(B2Vec2.SubVV(B2Vec2.AddVV(cB, rB, B2Vec2.s_t0), B2Vec2.AddVV(cA, rA, B2Vec2.s_t1), B2Vec2.s_t2), B2Rot.MulRV(qA, this.m_linearOffset, B2Vec2.s_t3), this.m_linearError);
