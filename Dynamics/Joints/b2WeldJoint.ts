...
export class B2WeldJoint extends B2Joint {
	...
	public SolveVelocityConstraints(data: B2SolverData): void {
		...
		if (this.m_frequencyHz > 0) {
			...
			const impulse1: B2Vec2 = B2Mat33.MulM33XY(
				this.m_mass,
				Cdot1.x,
				Cdot1.y,
			...
			const impulse: B2Vec3 = B2Mat33.MulM33XYZ(
				this.m_mass,
				Cdot1.x,
				Cdot1.y,
				Cdot2,
			...
			const P: B2Vec2 = B2WeldJoint.SolveVelocityConstraints_s_P.Set(
				impulse.x,
				impulse.y
			)
	...
	public SolvePositionConstraints(data: B2SolverData): boolean {
		...
		if (this.m_frequencyHz > 0) {
			...
			// B2Vec2 P(impulse.x, impulse.y);
			const P: B2Vec2 = B2WeldJoint.SolvePositionConstraints_s_P.Set(
				impulse.x,
				impulse.y
			)
