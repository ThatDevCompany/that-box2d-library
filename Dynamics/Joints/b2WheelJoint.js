...
class B2WheelJoint extends b2Joint_1.B2Joint {
    ...
    SolveVelocityConstraints(data) {
        ...
        {
            const Cdot = b2Math_1.B2Vec2.DotVV(this.m_ax, b2Math_1.B2Vec2.SubVV(vB, vA, b2Math_1.B2Vec2.s_t0)) +
                this.m_sBx * wB -
                this.m_sAx * wA;
        ...
        {
            const Cdot = b2Math_1.B2Vec2.DotVV(this.m_ay, b2Math_1.B2Vec2.SubVV(vB, vA, b2Math_1.B2Vec2.s_t0)) +
                this.m_sBy * wB -
                this.m_sAy * wA;
