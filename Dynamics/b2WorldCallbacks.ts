...
export class B2ContactListener {
	...
	/// #if B2_ENABLE_PARTICLE
	public BeginContactFixtureParticle(
		system: B2ParticleSystem,
		contact: B2ParticleBodyContact
	): void {}

	public EndContactFixtureParticle(
		system: B2ParticleSystem,
		contact: B2ParticleBodyContact
	): void {}

	public BeginContactParticleParticle(
		system: B2ParticleSystem,
		contact: B2ParticleContact
	): void {}

	public EndContactParticleParticle(
		system: B2ParticleSystem,
		contact: B2ParticleContact
	): void {}
