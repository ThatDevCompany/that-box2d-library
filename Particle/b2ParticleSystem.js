...
exports.B2ParticleSystem = exports.B2ParticleSystemDef = exports.B2ParticleTriad = exports.B2ParticlePair = exports.B2ParticleBodyContact = exports.B2ParticleContact = exports.B2FixtureParticleQueryCallback = exports.B2GrowableBuffer = void 0;
...
class B2GrowableBuffer {
    ...
    Grow() {
        ...
        let newCapacity = this.capacity
            ? 2 * this.capacity
            : b2Settings_1.B2_minParticleSystemBufferCapacity;
...
class B2ParticleContact {
    ...
    ApproximatelyEqual(rhs) {
        ...
        return (this.indexA === rhs.indexA &&
            this.indexB === rhs.indexB &&
            this.flags === rhs.flags &&
            b2Math_1.B2Abs(this.weight - rhs.weight) < MAX_WEIGHT_DIFF &&
            b2Math_1.B2Vec2.DistanceSquaredVV(this.normal, rhs.normal) < MAX_NORMAL_DIFF_SQ);
    }
}
...
class B2ParticleSystem {
    ...
    SetParticleLifetime(index, lifetime) {
        ...
        let newExpirationTime = quantizedLifetime > 0.0
        ...
        if (particleFlags & B2ParticleSystem.k_triadFlags) {
            ...
            let callback = function UpdateTriadsCallback(a, b, c) {
                ...
                if ((af | bf | cf) & B2ParticleSystem.k_triadFlags &&
                    ...
                    triad.s =
                        b2Math_1.B2Vec2.CrossVV(pa, pb) +
                            b2Math_1.B2Vec2.CrossVV(pb, pc) +
                            b2Math_1.B2Vec2.CrossVV(pc, pa);
                }
            };
    ...
    FilterContacts(contacts) {
        ...
        let predicate = function (contact) {
            return (contact.flags & 131072 /* B2_particleContactFilterParticle */ &&
    ...
    static B2ParticleContactIsZombie(contact) {
        return ((contact.flags & 2 /* B2_zombieParticle */) ===
            2 /* B2_zombieParticle */);
    }
                        ...
                        if (this.IsRigidGroup(cGroup)) {
                            ...
                            if (inertia > 0) {
                                ...
                                cGroup.m_angularVelocity +=
                                    b2Math_1.B2Vec2.CrossVV(b2Math_1.B2Vec2.SubVV(pc, cGroup.GetCenter(), b2Math_1.B2Vec2.s_t0), f) / inertia;
                            }
                        }
                        else {
    ...
    SolveElastic(step) {
        ...
        for (let k = 0; k < this.m_triadBuffer.count; k++) {
            ...
            if (triad.flags & 16 /* B2_elasticParticle */) {
                ...
                let r = s_r;
                r.s =
                    b2Math_1.B2Vec2.CrossVV(oa, pa) +
                        b2Math_1.B2Vec2.CrossVV(ob, pb) +
                        b2Math_1.B2Vec2.CrossVV(oc, pc);
    ...
    SolveZombie() {
        ...
        for (let i = 0; i < this.m_count; i++) {
            ...
            if (flags & 2 /* B2_zombieParticle */) {
                ...
                if (flags & 512 /* B2_destructionListenerParticle */ &&
                    destructionListener) {
        ...
        for (let group = this.m_groupList; group; group = group.GetNext()) {
            ...
            if (firstIndex < lastIndex) {
                ...
                if (!(group.m_groupFlags & 4 /* B2_particleGroupCanBeEmpty */)) {
                    this.SetGroupFlags(group, group.m_groupFlags |
                        8 /* B2_particleGroupWillBeDestroyed */);
                }
            }
        }
    ...
    GetFixtureContactListener() {
        return this.m_allParticleFlags &
            16384 /* B2_fixtureContactListenerParticle */
    ...
    SetUserOverridableBuffer(buffer, newData, newCapacity) {
        B2Assert((newData !== null && newCapacity > 0) ||
    ...
    IsRigidGroup(group) {
        return (group !== null &&
            (group.m_groupFlags & 2 /* B2_rigidParticleGroup */) !== 0);
    }
...
B2ParticleSystem.xShift = B2ParticleSystem.tagBits -
...
(function (B2ParticleSystem) {
    ...
    class InsideBoundsEnumerator {
        ...
        GetNext() {
            while (this.m_first < this.m_last) {
                let xTag = (this.m_system.m_proxyBuffer.data[this.m_first].tag &
    ...
    class UpdateBodyContactsCallback extends B2FixtureParticleQueryCallback {
        ...
        ReportFixtureAndParticle(fixture, childIndex, a) {
            ...
            let s_rp = B2ParticleSystem.UpdateBodyContactsCallback
            ...
            if (d < this.m_system.m_particleDiameter &&
                ...
                let invAm = this.m_system.m_flagsBuffer.data[a] & 4 /* B2_wallParticle */
                    ? 0
    ...
    class SolveCollisionCallback extends B2FixtureParticleQueryCallback {
        ...
        ReportFixtureAndParticle(fixture, childIndex, a) {
            ...
            let s_output = B2ParticleSystem.SolveCollisionCallback
            ...
            if (fixture.RayCast(output, input, childIndex)) {
                ...
                p.x =
                    (1 - output.fraction) * input.p1.x +
                        ...
                        b2Settings_1.B2_linearSlop * n.x;
                p.y =
                    (1 - output.fraction) * input.p1.y +
                        output.fraction * input.p2.y +
                        b2Settings_1.B2_linearSlop * n.y;
