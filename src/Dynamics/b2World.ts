...
export class B2World {
	...
	public RayCast(
		callback: B2RayCastCallback | B2RayCastCallbackFunction,
		point1: B2Vec2,
		point2: B2Vec2
	): void {
		const broadPhase: B2BroadPhase = this.m_contactManager.m_broadPhase
	...
	public RayCastOne(point1: B2Vec2, point2: B2Vec2): B2Fixture {
		...
		function WorldRayCastOneWrapper(
			fixture: B2Fixture,
			point: B2Vec2,
			normal: B2Vec2,
			fraction: number
	...
	public RayCastAll(
		...
		function WorldRayCastAllWrapper(
			fixture: B2Fixture,
			point: B2Vec2,
			normal: B2Vec2,
			fraction: number
	...
	public Solve(step: B2TimeStep): void {
		...
		for (
			let c: B2Contact = this.m_contactManager.m_contactList;
			c;
			c = c.m_next
		) {
